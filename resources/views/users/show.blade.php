                ...
                <div class="card-header text-center text-white bg-secondary">
                	...
                	<div class="card-body">
                    	...
                    	@endif
                    	 ...
                    	 <h4> Detalles de los Usuarios del Sistema: </h4>
                    	...
                    	<div class="py-3">
                            ...
                            <div class="form-row mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <h5>{{ date('d-m-Y H:i:s', strtotime($user->created_at)) }}</h5>
                            ...
                            <div class="form-row mb-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <label class="text-muted">Dependencia</label>

                                    <h5 >{{ $user->dependency->name }}</h5>
                            ...
                            <div class="form-row">
                                ...
                                <a href="{{ route('users.index') }}" class="btn btn-secondary btn-block" type="button">
