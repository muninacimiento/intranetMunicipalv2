                ...
                <div class="card-body">
                    <div class="row py-3">
                        <div class="col text-center">                            
                            <h3>Informe de Mantenciones Realizadas por Vehículo Municipal</h3>
                    ...
                    @endif
                    <form class="form-inline" method="GET" action="{{ route('mantenciones.buscarMantenciones') }}">
                        <div class="col"> 
