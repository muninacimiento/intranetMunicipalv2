                ...
                <div class="card-header text-center text-white bg-secondary">
                	...
                	<div class="card-body">
                    	...
                    	@endif
                    	 ...
                    	 <h4> Detalles de la Dependencia Municipal: </h4>
                    	...
                    	<div class="py-3">
                            ...
                            <div class="form-row mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <h5>{{ date('d-m-Y H:i:s', strtotime($dependency->created_at)) }}</h5>
                            ...
                            <div class="form-row mb-3">
                                ...
                                <div>
                                    ...
                                    <label class="text-muted">Regsitrada por</label>
                                                                
                                    <h5>{{ $dependency->user->name }}</h5> 
