                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.cerrar', $solicitud->id) }}">
                                        ...
                                        <button class="btn btn-block btn-info" type="submit">
                                            <i class="icofont-close-circled h5"></i> Cerrar Solicitud
                                        </button>                                        
                                    </form>    
                                </div>
                                <div class="col-md-12 mb-2">                                    
                                    <a href="{{ route('reporteEntregaStock.pdf', $solicitud->id) }}" class="text-decoration-none" data-toggle="tooltip" data-placement="bottom" title="Imprimir Reporte Entrega Stock">
                                        <button type="button" class="btn btn-warning btn-block">
                                            <i class="icofont-printer h5"></i> Imprimir Reporte Entrega Stock
                                        </button>
                                    </a>
                                </div>
                                <div class="col-md-12">                                    
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <p class="modal-title" id="exampleModalLabel" style="font-size: 1.2em"><i class="icofont-tasks h5"></i> Entregar Productos de la Solicitud </p>
