                        ...
                        <div class="col-md-6">                            
                            <a href="#" class="text-decoration-none" data-toggle="modal" data-target="#createSolicitudModal">
                                <button class="btn btn-success btn-block boton">
                                    <i class="icofont-plus-circle h5"></i> Nueva Solicitud
                                </button>
                            </a>                            
                        </div>
                    </div>
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                @can('solicitud.update')
                                                    @if($solicitud->decretoPrograma === NULL)
                                                        <a href="#" class="btn btn-outline-primary btn-sm editInterna" data-toggle="tooltip" data-placement="bottom" title="Modificar la Solicitud">                                                
                                                            <i class="icofont-pencil-alt-5 h5"></i>
                                                        </a>
                                                    @else
                                                ...
                                                @can('solicitud.anular')
                                                    <a href="#" class="btn btn-outline-danger btn-sm delete" data-toggle="tooltip" data-placement="bottom" title="Anular Solicitud">
                                                        <i class="icofont-delete-alt h5"></i>
                                                    </a>
                                                @endcan
                                            </div>
                                        </td>
    ...
    <!-- ### Form ACTIVIDADES ### -->
                    ...
                    <div class="form-row">
                        <button class="btn btn-success btn-block boton" type="submit" form="createForm">
                            <i class="icofont-download"></i> Guardar Solicitud
                        </button>
...
<div class="modal fade" id="updateSolicitudPrograma" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <p class="modal-title" id="exampleModalLabel" style="font-size: 1.2em"><i class="icofont-pencil-alt-5"></i> Actualizar Solicitud </p>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" class="text-white">&times;</span>
                </button>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-danger text-white">
                <p class="modal-title" id="exampleModalLabel" style="font-size: 1.2em"><i class="icofont-trash"></i> Anular Solicitud </p>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" class="text-white">&times;</span>
                </button>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 form-row">
                        <button class="btn btn-danger btn-block" type="submit">
                            <i class="icofont-check-circled"></i> Anular Solicitud
                        </button>
                        <a href="{{ route('solicitud.index') }}" class="btn btn-secondary btn-block" type="reset">
                            <i class="icofont-arrow-left"></i> Cancelar
                        </a>
                    </div>
                </div>
