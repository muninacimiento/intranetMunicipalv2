        ...
        <div class="col-md-12">
            ...
            <div class="card border-secondary shadow">
                ...
                <div class="card-body">
                    ...
                    <h4> Nuevo Permiso del Sistema </h4>
                    	...
                    	<form method="POST" action="{{ route('permissions.store') }}" class="needs-validation" novalidate>
							...
							<div class="form-row">
								...
								<div class="col-md-6 mb-3">
									...
									<input type="text" class="form-control" id="name" name="name" placeholder="Nombre del Permiso" required>
								...
								<div class="col-md-6 mb-3">
									...
									<input type="text" class="form-control" id="slug" name="slug" placeholder="Ruta de Acceso" required>
							...
							<div class="mb-3 form-row">
								...
								<textarea type="textarea" class="form-control" id="description" name="description" placeholder="Descripción del Nuevo Permiso" required></textarea>
